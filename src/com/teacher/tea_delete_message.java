...
@WebServlet("/tea_delete_message")
public class tea_delete_message extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("tea_show_all_message").forward(request,response);
