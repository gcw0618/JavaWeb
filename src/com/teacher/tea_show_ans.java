...
@WebServlet("/tea_show_ans")
public class tea_show_ans extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ArrayList<Teacher> message_list=messages.show_all_message(t_id);
            request.setAttribute("message_list",message_list);
            request.getRequestDispatcher("/tea_show_ans.jsp").forward(request,response);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
