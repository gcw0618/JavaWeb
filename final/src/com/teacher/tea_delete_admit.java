...
@WebServlet("/tea_delete_admit")
public class tea_delete_admit extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean success=dao.delete_admit(teacher);
            if(success){
                message="<li>删除成功</li>";
            }
            else{
        ...
        request.getRequestDispatcher("tea_manage_admit?opt=2").forward(request,response);
